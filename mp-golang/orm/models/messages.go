...
var (
	messageColumns               = []string{"id", "project_id", "user_id", "body", "created_at", "updated_at"}
	messageColumnsWithoutDefault = []string{"project_id", "user_id", "body"}
...
func (o *Message) Project(mods ...qm.QueryMod) projectQuery {
...
func (messageL) LoadProject(ctx context.Context, e boil.ContextExecutor, singular bool, maybeMessage interface{}, mods queries.Applicator) error {
	var slice []*Message
	var object *Message
...
// SetProjectG of the message to the related item.
// Sets o.R.Project to related.
// Adds o to related.R.Messages.
// Uses the global database handle.
func (o *Message) SetProjectG(ctx context.Context, insert bool, related *Project) error {
	return o.SetProject(ctx, boil.GetContextDB(), insert, related)
}

// SetProject of the message to the related item.
// Sets o.R.Project to related.
// Adds o to related.R.Messages.
func (o *Message) SetProject(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Project) error {
	var err error
	if insert {
